...
{
    public class ValueDeltaPercentFormater : IMultiValueConverter
    {
        private static readonly ValueDeltaPercentFormater _default = new ValueDeltaPercentFormater();
        ...
        /// The default.
        /// </value>
        public static ValueDeltaPercentFormater Default
        {
            get { return _default; }
        }
