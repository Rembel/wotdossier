...
namespace WotDossier.Framework.Applications
{
    ...
    /// </i:Interaction.Triggers>
    /// </example>
    public class ClickEventToCommand : TriggerAction<FrameworkElement>
    {
        // Fields
        ...
        public static readonly DependencyProperty CommandParameterProperty = DependencyProperty.Register("CommandParameter", typeof(object), typeof(ClickEventToCommand), new PropertyMetadata(null, OnCommandParameterChanged));
        public static readonly DependencyProperty CommandProperty = DependencyProperty.Register("Command", typeof(DelegateCommand<object>), typeof(ClickEventToCommand), new PropertyMetadata(null, OnCommandChanged));
        public static readonly DependencyProperty MustToggleIsEnabledProperty = DependencyProperty.Register("MustToggleIsEnabled", typeof(bool), typeof(ClickEventToCommand), new PropertyMetadata(false, OnMustToggleIsEnabledChanged));
        ...
        protected override void Invoke(object parameter)
        {
            if (!AssociatedElementIsDisabled())
            {
                ...
                FrameworkElement control = GetAssociatedObject() as FrameworkElement;
                
                if ((command != null) && control != null && command.CanExecute(control.DataContext))
                {
        ...
        {
            ClickEventToCommand command = d as ClickEventToCommand;
            if (command != null)
            {
                if (e.OldValue != null)
                {
