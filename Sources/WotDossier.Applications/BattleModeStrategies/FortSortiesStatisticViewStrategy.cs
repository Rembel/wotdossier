...
namespace WotDossier.Applications.BattleModeStrategies
{
    public class FortSortiesStatisticViewStrategy : StatisticViewStrategyBase
    {
        ...
        public FortSortiesStatisticViewStrategy(DossierRepository dossierRepository)
        ...
        {
            return new FortSortiesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic);
        }
        ...
        {
            return new FortSortiesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic, oldStatisticEntities);
        }
        ...
        public override PlayerEntity UpdatePlayerStatistic(int playerId, List<TankJson> tanks, Player serverStatistic)
        {
            ...
            FortSortiesStatAdapter newSnapshot = new FortSortiesStatAdapter(tanks);
