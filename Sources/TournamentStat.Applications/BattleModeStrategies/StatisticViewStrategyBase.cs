...
namespace TournamentStat.Applications.BattleModeStrategies
{
    ...
    public abstract class StatisticViewStrategyBase
    {
        ...
        /// <returns></returns>
        public abstract List<ITankStatisticRow> GetTanksStatistic(int playerId, IEnumerable<TournamentTank> tanks);
        ...
        /// <param name="tanks"></param>
        /// <returns></returns>
        protected List<ITankStatisticRow> GetTanksStatistic<T>(int playerId, IEnumerable<TournamentTank> tanks) where T : TankStatisticEntityBase
        {
