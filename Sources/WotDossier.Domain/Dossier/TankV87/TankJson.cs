...
namespace WotDossier.Domain.Dossier.TankV87
{
    ...
    public class TankJson87
    {
        ...
        private Achievements_87 _achievements = new Achievements_87();

        public Achievements_87 Achievements
        {
        ...
        private AchievementsFort_87 _fortAchievements = new AchievementsFort_87();

        public AchievementsFort_87 FortAchievements
        {
