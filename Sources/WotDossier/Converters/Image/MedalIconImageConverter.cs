...
{
    public class MedalIconImageConverter : IValueConverter
    {
        private static readonly MedalIconImageConverter _default = new MedalIconImageConverter();

        public static MedalIconImageConverter Default
        {
            get { return _default; }
        }
