...
using WotDossier.Converters.Ratings;
...
namespace WotDossier.Converters.Color
{
    ...
    /// </summary>
    public class FragsToColorConverter : IValueConverter
    {
        private static readonly FragsToColorConverter defaultInstance = new FragsToColorConverter();
        ...
        /// The default.
        /// </value>
        public static FragsToColorConverter Default { get { return defaultInstance; } }
