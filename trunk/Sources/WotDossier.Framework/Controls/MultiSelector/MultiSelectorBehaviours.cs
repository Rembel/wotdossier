...
namespace WotDossier.Framework.Controls.MultiSelector
{
    /// <summary>
    ...
    public static class MultiSelectorBehaviours
    {
        ...
        private class SynchronizationManager
        {
            ...
            {
                if (selector is System.Windows.Controls.Primitives.MultiSelector)
                {
                    return (selector as System.Windows.Controls.Primitives.MultiSelector).SelectedItems;
                }
