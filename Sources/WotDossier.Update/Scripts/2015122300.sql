...
ALTER TABLE [HistoricalBattlesAchievements] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [HistoricalBattlesStatistic] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [Player] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [PlayerAchievements] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [PlayerStatistic] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [Replay] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [Tank] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [TankHistoricalBattleStatistic] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [TankStatistic] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [TankTeamBattleStatistic] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [TeamBattlesAchievements] ADD [Rev] int NOT NULL default(2015122300);
ALTER TABLE [TeamBattlesStatistic] ADD [Rev] int NOT NULL default(2015122300);
